...
public class XBeanTest {
	...
	public void testUsingConvertor() {
		...
		ClientBeanCustom c = new ClientBeanCustom(123, "Hello", 2500, 20000000000l, 888l,
				6777888889333l, "string", instance.getTime());
		...
		annotationBeanConverter.convertByInstanceConverter(convert, converterSet, c);
		...
		// Assert.assertEquals("string converted!!!!",
		// convert.getDiffNameConvertorAnother());
